var $jscomp$this=this,$jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
...
$jscomp.initSymbol=function(){};$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(d,l){this.$jscomp$symbol$id_=d;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:l})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var e=0,f=function(d){if(this instanceof f)throw new TypeError("Symbol is not a constructor");return new b("jscomp_symbol_"+(d||"")+"_"+e++,d)};return f},"es6","es3");
...
break;case 2:g(k.result_);break;default:throw Error("Unexpected state: "+k.state_);}}var k=this;null==this.onSettledCallbacks_?l.asyncExecute(h):this.onSettledCallbacks_.push(h);this.isRejectionHandled_=!0};d.resolve=e;d.reject=function(c){return new d(function(g,h){h(c)})};d.race=function(c){return new d(function(g,h){for(var k=$jscomp.makeIterator(c),m=k.next();!m.done;m=k.next())e(m.value).callWhenSettled_(g,h)})};d.all=function(c){var g=$jscomp.makeIterator(c),h=g.next();return h.done?e([]):new d(function(k,
m){function t(q){return function(r){n[q]=r;p--;0==p&&k(n)}}var n=[],p=0;do n.push(void 0),p++,e(h.value).callWhenSettled_(t(n.length-1),m),h=g.next();while(!h.done)})};return d},"es6","es3");var sleep=function(a){return new Promise(function(b){return setTimeout(b,a)})};
$(document).ready(function(){function a(){var e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){switch(d.nextAddress){case 1:e=$("#title .container"),f=e.outerHeight();case 2:if(!(100>f)){d.jumpTo(3);break}return d.yield(sleep(50),4);case 4:f=e.outerHeight();d.jumpTo(2);break;case 3:$("#grid").css({"grid-template-rows":"[top] "+f+"px [title-bottom] auto [bottom]"}),d.jumpToEnd()}})}function b(){a();var e=$(window).outerHeight(),f=$("#title").outerHeight(),d=$("#navbar").outerHeight(),
l=$("#carousel").outerHeight(),c=$("#footer").outerHeight();e=e-f-d-(void 0===l?0:l)-c;$("#content .container").css({"min-height":e+"px"})}console.log("This site brought to you by McCarthy Code.");console.log("https://mccarthycode.com/");$("a.external-link").after('<span class="user-select-none"> <i class="fas fa-external-link-alt" title="External Link"></i></span>');b();$(window).on("resize orientationchange",b);$("#navbarMenuButton").click(function(){$("#navbarCollapse").slideToggle()});$(window).on("resize orientationchange",
function(){768<=$($jscomp$this).width()?$("#navbarCollapse").css("display","inline"):$("#navbarCollapse").hide()})});
