...
$jscomp.polyfillIsolated=function(a,b,e,g){var d=a.split(".");a=1===d.length;g=d[0];g=!a&&g in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var l=0;l<d.length-1;l++){var c=d[l];if(!(c in g))return;g=g[c]}d=d[d.length-1];e=$jscomp.IS_SYMBOL_NATIVE&&"es6"===e?g[d]:null;b=b(e);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,d,{configurable:!0,writable:!0,value:b}):b!==e&&($jscomp.propertyToPolyfillSymbol[d]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(d):$jscomp.POLYFILL_PREFIX+d,d=
$jscomp.propertyToPolyfillSymbol[d],$jscomp.defineProperty(g,d,{configurable:!0,writable:!0,value:b})))};$jscomp.underscoreProtoCanBeSet=function(){var a={a:!0},b={};try{return b.__proto__=a,b.a}catch(e){}return!1};$jscomp.setPrototypeOf=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null;
...
$jscomp.asyncExecutePromiseGenerator=function(a){function b(g){return a.next(g)}function e(g){return a.throw(g)}return new Promise(function(g,d){function l(c){c.done?g(c.value):Promise.resolve(c.value).then(b,e).then(l,d)}l(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.asyncExecutePromiseGeneratorProgram=function(a){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(a)))};
$jscomp.initSymbol=function(){};$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(d,l){this.$jscomp$symbol$id_=d;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:l})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var e=0,g=function(d){if(this instanceof g)throw new TypeError("Symbol is not a constructor");return new b("jscomp_symbol_"+(d||"")+"_"+e++,d)};return g},"es6","es3");
...
m){function t(q){return function(r){n[q]=r;p--;0==p&&k(n)}}var n=[],p=0;do n.push(void 0),p++,e(h.value).callWhenSettled_(t(n.length-1),m),h=f.next();while(!h.done)})};return d},"es6","es3");$jscomp.findInternal=function(a,b,e){a instanceof String&&(a=String(a));for(var g=a.length,d=0;d<g;d++){var l=a[d];if(b.call(e,l,d,a))return{i:d,v:l}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,e){return $jscomp.findInternal(this,b,e).v}},"es6","es3");
var sleep=function(a){return new Promise(function(b){return setTimeout(b,a)})};
$(document).ready(function(){function a(){var b=$("#carousel"),e=0;b.find("img").each(function(){var g=this,d,l,c,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:d=g.naturalWidth,l=g.naturalHeight;case 2:if(d&&l){k.jumpTo(3);break}return k.yield(sleep(50),4);case 4:d=g.naturalWidth;l=g.naturalHeight;k.jumpTo(2);break;case 3:c=Math.min(d,$(window).width()),f=Math.min(l,l*$(window).width()/d),h=$(g),h.width(c),h.height(f),e=Math.max(f,e),k.jumpToEnd()}})});
b.find(".carousel-inner, .carousel-item").css("height",e+"px")}$("#carousel").hover(function(){$(this).carousel("pause")},function(){$(this).carousel("cycle")});a();$(window).on("resize orientationchange",a)});
